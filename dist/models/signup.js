...
var User = /** @class */ (function () {
    ...
    User.prototype.cleanUp = function () {
        ...
        if (typeof this.data.company_name != "string")
    ...
    User.prototype.validate = function () {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var email_to_check, emailExists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!validator_1.default.isEmail(this.data.email)) return [3 /*break*/, 2];
                        return [4 /*yield*/, utils_1.Company.findOne({ email: email_to_check })];
                    case 1:
                        emailExists = _a.sent();
                        //@ts-ignore
                        emailExists && (emailExists === null || emailExists === void 0 ? void 0 : emailExists.email) && console.log("doesEmailExist result:", emailExists.email);
                        if (emailExists && (emailExists === null || emailExists === void 0 ? void 0 : emailExists.email)) {
